...
export class CreateFuncionarioDto implements ICreateFuncionarioDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.setor = _data["setor"];
            this.salario = _data["salario"];
            this.dataAdmissao = _data["dataAdmissao"];
            this.dataDemissao = _data["dataDemissao"];
    ...
    static fromJS(data: any): CreateFuncionarioDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateFuncionarioDto();
        result.init(data);
        return result;
    }
...
export class UpdateFuncionarioDto implements IUpdateFuncionarioDto {
    id: number | undefined;
    nome: string | undefined;
    cpf: string | undefined;
    email: string | undefined;
    ...
    constructor(data?: IUpdateFuncionarioDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateFuncionarioDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateFuncionarioDto();
        result.init(data);
        return result;
    }
...
export interface IUpdateFuncionarioDto {
    id: number | undefined;
    nome: string | undefined;
    cpf: string | undefined;
    email: string | undefined;
