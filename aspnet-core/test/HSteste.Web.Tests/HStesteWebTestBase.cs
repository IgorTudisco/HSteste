...
using HSteste.Models.TokenAuth;
...
public abstract class HStesteWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static HStesteWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(HStesteWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<HStesteDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<HStesteDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<HStesteDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<HStesteDbContext, Task<T>> func)
    {
        T result;
